    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <h5 class="mb-2 mt-4">VENTAS MENSUALES</h5>
                <div class="row">
                    <div class="col-lg-6 col-12 m-3"  >
                        SELECCIONA EL MES: <input type="month" value="2022-02" name="dia" id="dia" onchange="establecer_mes(this.value)">

                    </div>
                </div>
                <div class="row bg-info p-3 col-md-9">
                    <div class="col-md-4">MES SELECCIONADO: </div>
                    <div class="col-md-2" id="messeleccionado"> </div>
                </div>

                <div class="row">


                    <h5 class="mb-2 mt-4">VENTAS DEL MES</h5>
                </div>
                <div class="row">
                    <div class="col-md-4">
...
@section("js")
    ...
    <script>
        function establecer_mes(mes) {
            $("#messeleccionado").html(mes);
