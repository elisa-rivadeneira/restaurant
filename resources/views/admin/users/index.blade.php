...
@section('content')
    ...
    <a href="/admin/users/create" class="btn btn-primary mb-4" >CREAR UN USUARIO</a>
        ...
        @foreach ($items as $key => $item)
            ...
            <tr>
                ...
                <td>   <!-- Button trigger modal -->
                    <form action="/admin/users/{{$item->id}}" method="POST" class="formelimi">
                        <div class="row" >
                                       <div  >
                                           <a href="/admin/users/{{$item->id}}/edit" class="btn btn-info">Editar</a>
            ...
            <div class="modal fade" id="ordenplato{{ $item->id }}" tabindex="-1" role="dialog" aria-hidden="true">
