...
@section('content')
    ...
    <a href="/mesas/create" class="btn btn-primary mb-4">CREAR</a>
        ...
        @foreach ($items as $item)
            ...
            <tr>
                ...
                <td>   <!-- Button trigger modal -->
                    <form action="{{route ('mesas.destroy', $item->id) }}" method="POST" class="formelimi">




                        <a href="/mesas/{{$item->id}}/edit" class="btn btn-info"> Editar</a>
                        @csrf
                        @method('DELETE')
